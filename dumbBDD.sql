...
(2, 'Alternant Développeur Web Front-End', 'Alternance', 'Paris, France', 'Selon grille légale', 'Agence digitale accompagnant ses clients dans la création de sites web et d’applications sur mesure. Vous intégrerez une équipe dynamique où l’apprentissage, la transmission de compétences et l’implication sur des projets concrets sont au cœur du fonctionnement.', 'Encadré par un développeur expérimenté, vous participerez à l’intégration d’interfaces web, au développement de nouvelles fonctionnalités et à la correction de bugs. Vous serez également amené à collaborer avec les designers pour garantir la qualité visuelle et ergonomique des projets.', 'HTML, CSS, JavaScript, bases en React ou Vue, Git', 'Encadrement personnalisé, ambiance bienveillante, projets variés, possibilité d’embauche', 'Entretien visio → test technique → entretien final', 'Contrat de 12 mois, démarrage en septembre', '2026-05-05 05:21:30', 'presentiel', 'fraiseur'),
(3, 'Tourneur CN Confirmé', 'CDI', 'Lannion, France', '28 000€ - 35 000€ brut/an', 'Atelier de précision mécanique spécialisé dans l’aéronautique, reconnu pour son savoir-faire technique et la qualité de ses finitions. Nous disposons d’un parc machine récent et performant.', 'Réglage et programmation de tours à commande numérique, usinage de pièces complexes en petites et moyennes séries, contrôle dimensionnel rigoureux et maintenance de premier niveau des machines.', 'Lecture de plans, programmation ISO/Fanuc, utilisation d’outils de mesure (palmer, pied à coulisse)', 'Primes de productivité, paniers repas, équipements de protection premium fournis', 'Entretien technique en atelier → essai sur machine → entretien final', 'Poste en 2x8', '2026-05-07 07:00:00', 'presentiel', 'tourneur'),
